...
?>
<h1 style="margin-top:33px">Achtung Online</h1> 
...
<div class="container" id="body_container">
  ...
  <div class="row" >
    <div class="col-md-4">
      <img data-src="holder.js/400*300" class="img-thumbnail" alt="400*300" style="width: 400px; height: 300px;" src="img/gameplay_square.png">
      ...
      <div class="col-md-4">
        ...
        <img data-src="holder.js/400*300" class="img-thumbnail" alt="400*300" style="width: 400px; height: 300px;" src="img/gameplay_circle.png">
        ...
        <div class="col-md-4">
          ...
          <img data-src="holder.js/400*300" class="img-thumbnail" alt="400*300" style="width: 400px; height: 300px;" src="img/gameplay_options.png">
